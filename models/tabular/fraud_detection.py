...
# import pandas as pd
# from statics import ROOT_DIR
# dataset_path = ROOT_DIR + "/dataset/fd_test2/combined_trimmed.csv"
# df = pd.read_csv(dataset_path)
...
# n_df.to_csv(ROOT_DIR + "/dataset/fd_test2/combined_refine.csv", index=False, encoding="utf-8-sig")
#
...
# import pandas as pd
# from statics import ROOT_DIR
# dataset_path = ROOT_DIR + "/dataset/fd_test2/combined_o_e.csv"
# df = pd.read_csv(dataset_path)
#
#
# #
# # evnt_39 = {"CCMCM0103SE01": 0,
# #            "CCMFD0101RG01": 0,
# #            "CCMMS0101SL01": 0,
# #            "CCMCP0801": 0,
# #            "CCMFD0101RG02": 0,
...
#
# tabular_dataset.to_csv(ROOT_DIR + "/dataset/fd_test2/combined_e_o_tabular.csv", sep=",",
...
# from statics import ROOT_DIR
#
# dataset_path = ROOT_DIR + "/dataset/fd_test2/combined_e_o_tabular.csv"
# df = pd.read_csv(dataset_path)
...
# df = df[cols]
# df.to_csv(ROOT_DIR + "/dataset/fd_test2/combined_e_o_tabular_fc.csv", sep=",", index=False, encoding="utf-8-sig")
# print("done")
...
# from statics import ROOT_DIR
#
# dataset_path = ROOT_DIR + "/dataset/fd_test2/combined_e_o_tabular_fc.csv"
# df = pd.read_csv(dataset_path)
...
# df.to_csv(ROOT_DIR + "/dataset/fd_test2/combined_e_o_tabular_fc_fs.csv",
...
dataset_path = ROOT_DIR + "/dataset/fd_test2/combined_e_o_tabular_fc_fs.csv"
df = pd.read_csv(dataset_path)
df_labels = df[["label"]]
dft = df.drop(["SEQ", "label", "ETC"], axis=1)
feature_list = dft.keys().tolist()
...
for i in range(hp_resample_count):
    num_neg = len(df[df["label"] == 1])
    print("resample")
    sm = SMOTE(random_state=i, sampling_strategy=0.10, k_neighbors=5)
    ad = ADASYN(random_state=i + 1, sampling_strategy=0.10)
    ad2 = SMOTE(random_state=i + 2, sampling_strategy=0.03)
    ...
    X_ovs_train, y_ovs_train, X_ovs_test, y_ovs_test = \
        split_train_test(X_ovs_stacked, y_ovs_stacked, num_neg,
                         int(num_pos / 2), int(num_neg / 10), True)

...
import pandas as pd
from statics import ROOT_DIR
dataset_path = ROOT_DIR + "/dataset/fd_test2/all_dataset_trimmed_train_refine.csv"
df = pd.read_csv(dataset_path)
...
tabular_dataset.to_csv(ROOT_DIR + "/dataset/fd_test2/all_dataset_trimmed_train_refine_tabular.csv", sep=",",

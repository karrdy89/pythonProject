...
#
# label_output = LabelLayer(label_vocab.get_vocabulary(), len(label_vocab.get_vocabulary()), name='result')(model.outputs)
# label_model = tf.keras.Model(model.input, label_output)
# label_model.summary()
# label_model.predict(tf.constant([X_test[0]]))

# model.save('saved_models/NBO/101')
# model = tf.keras.models.load_model('saved_models/NBO/101', custom_objects={"loss_function": loss_function})
